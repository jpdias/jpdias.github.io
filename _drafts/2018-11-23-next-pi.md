...
It's possible that the 16x2 LCD will be misconfigured at the contrast level. To adjust it, just turn the potentiometer screw (on both direction) of the I2C conversor until you get the *right* contrast (positioned in the back of the LCD).

## Assembly & Final Result

![Pic1](/images/nextpi/pic1.png)

![Pic2](/images/nextpi/pic1.png)

![Pic3](/images/nextpi/pic1.png)