...
After some trial and error, nginx was the solution. However, as per the official solution, this was related to the [C10k problem](https://en.wikipedia.org/wiki/C10k_problem) to which the nginx was the first to be released that solved this challenge.
